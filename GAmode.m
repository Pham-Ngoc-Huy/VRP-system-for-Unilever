...
while iter_GA <= Number_of_GA_Iteration
    ...
    for c = 1:child_set 
        ...
        % iter_outer = 1;
        % start outer loop
        for iter_outer = 1: Number_outer_loop_muitation
            array_sample = array_child;
            array_sample = muitation_self(array_sample, Num_route + 1, length(array_sample));
